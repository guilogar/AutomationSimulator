...
public class Channel {
     ...
     * @return JSON string.
     * @throws Exception The request cannot be made.
     * @throws ThingSpeakException The request is invalid.
     */
    private String thingRequest(String url) throws Exception, ThingSpeakException {
     ...
     * @throws ThingSpeakException The request is invalid.
     */
    private String thingRequest(String url, FeedParameters options) throws Exception, ThingSpeakException {
        GetRequest request = Unirest.get(url);
        if (!this.isPublic) {
            request.field("key", this.readAPIKey);
        }
     ...
     * @throws ThingSpeakException The request is invalid.
     */
    public Integer update(Entry entry) throws Exception, ThingSpeakException {
     ...
     * @throws ThingSpeakException The request is invalid.
     */
    public Feed getChannelFeed() throws Exception, ThingSpeakException {
     ...
     * @throws ThingSpeakException The request is invalid.
     */
    public Feed getChannelFeed(FeedParameters options) throws Exception, ThingSpeakException {
        String url = APIURL + "/channels/" + this.channelId + "/feed.json";
     ...
     * @throws ThingSpeakException The request is invalid.
     */
    public Entry getLastChannelEntry() throws Exception, ThingSpeakException {
     ...
     * @throws ThingSpeakException The request is invalid.
     */
    public Entry getLastChannelEntry(FeedParameters options) throws Exception, ThingSpeakException {
        String url = APIURL + "/channels/" + this.channelId + "/feed/last.json";
     ...
     * @throws ThingSpeakException The request is invalid.
     */
    public Feed getFieldFeed(Integer fieldId) throws Exception, ThingSpeakException {
     ...
     * @throws ThingSpeakException The request is invalid.
     */
    public Feed getFieldFeed(Integer fieldId, FeedParameters options) throws Exception, ThingSpeakException {
        String url = APIURL + "/channels/" + this.channelId + "/field/" + fieldId + ".json";
        return gson.fromJson(thingRequest(url, options), Feed.class);
    }
     ...
     * @throws ThingSpeakException The request is invalid.
     */
    public Entry getLastFieldEntry(Integer fieldId) throws Exception, ThingSpeakException {
     ...
     * @throws ThingSpeakException The request is invalid.
     */
    public Entry getLastFieldEntry(Integer fieldId, FeedParameters options) throws Exception, ThingSpeakException {
        String url = APIURL + "/channels/" + this.channelId + "/field/" + fieldId + "/last.json";
        return gson.fromJson(thingRequest(url, options), Entry.class);
    }
     ...
     * @throws ThingSpeakException The request is invalid.
     */
    public Feed getStatusFeed() throws Exception, ThingSpeakException {
     ...
     * @throws ThingSpeakException The request is invalid.
     */
    public Feed getStatusFeed(FeedParameters options) throws Exception, ThingSpeakException {
        String url = APIURL + "/channels/" + this.channelId + "/status.json";
        return gson.fromJson(thingRequest(url, options), Feed.class);
    }
